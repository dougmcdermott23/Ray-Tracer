...
void RotateX(struct object3D *o, double theta);	// Rotate theta radians CCW around X axis
void RotateY(struct object3D *o, double theta);	// Rotate theta radians CCW around Y axis
void RotateZ(struct object3D *o, double theta);	// Rotate theta radians CCW around Z axis
...
void newPoint(double px, double py, double pz, struct point3D *p);
void newPLS(struct point3D *p0, double r, double g, double b, struct pointLS *ls);
...
inline void newRay(struct point3D *p0, struct point3D *d, struct ray3D *ray) {
  ray->p0.px = p0->px;
  ray->p0.py = p0->py;
  ray->p0.pz = p0->pz;
  ray->p0.pw = 1.0;
